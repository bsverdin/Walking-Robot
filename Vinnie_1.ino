...
<html>
  ...
  <body>
    ...
    <table>
      ...
      <tr><td></td><td align="center"><button class="button button4" id="flash" onmousedown="toggleCheckbox('flash');" ontouchstart="toggleCheckbox('flash');" onmouseup="toggleCheckbox('flashoff');" ontouchend="toggleCheckbox('flashoff');">Flash</button></td><td></td></tr>
    </table>
   <script>
